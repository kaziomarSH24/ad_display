...
<x-app-layout>
    ...
    <div class="pt-7">
        ...
        <div class="tabs-container f-inter mt-20">
            <div class="bg-[#F7F7F7] lg:w-[28rem] rounded-[2px] mt-[130px]">
            </div>
        ...
        <div class="bg-[#FFFFFF] rounded-[12px] pt-3 pb-8 px-4 mb-10">
            <h3 class="test-[#0D2927] f-plus font-[500] text-[24px] mb-6">Edit Category</h3>
            <div class="lg:w-[35rem] mx-auto">
                <form action="{{ route('category.update' , $category->id) }}" method="post">
                    ...
                    <div class="f-inter flex flex-col mb-6">
                        ...
                        <textarea name="description" class="bg-[#EEF6F1] border border-[#F3FFF2] py-4 px-3 text-[16px] font-[400] text-[#323232] rounded-[5px] placeholder-[#323232]" id="description" cols="10" rows="5">{{ $category->description }}</textarea>
                        @error('description')
                            <span class="text-red-600">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="f-inter flex flex-col mb-6">
                        ...
                        <select name="status" id="status" class="bg-[#EEF6F1] border border-[#F3FFF2] py-4 px-3 text-[16px] font-[400] text-[#323232] rounded-[5px] placeholder-[#323232]">
                    ...
                    <div class="lg:w-[20rem] mx-auto mb-5 pb-5">
                        <button type="submit"
                            class="f-plus text-[16px] font-[500] text-[#FFFFFF] bg-[#228B22] rounded-[4px] py-3 w-full">Update</button>
                    </div>
