...
<x-app-layout>
    ...
    <div class="pt-7">
        ...
        <div class="pt-20 pb-6">
            {{-- <a href="{{ route('sub-category.create') }}"
                ...
                Add New Sub Category <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
    ...
    <div class="bg-[#FFFFFF] rounded-[12px] pt-3 pb-10 mb-10 px-4">
        <h3 class="text-[#0D2927] f-plus font-[500] text-[24px]">Sub Category</h3>
            ...
            <table
                ...
                <tbody>
                    ...
                    @forelse ($subCategories as $index=>$subCategory)
                            ...
                            <td class="px-4 py-2  text-[14px] f-inter font-[400] text-[#3C4151]">
                            ...
                            <td class="px-4 py-2">
                                <div class="flex justify-end pr-5">
                                    ...
                                    <a href="{{ route('sub-category.edit',$subCategory->slug) }}">
