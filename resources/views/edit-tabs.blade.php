...
<x-app-layout>
    ...
    <div class="pt-7">
        ...
        <div class="bg-[#FFFFFF] rounded-[12px] pt-3 pb-8 px-4 mb-10">
            <h3 class="test-[#0D2927] f-plus font-[500] text-[24px] mb-6">Edit Tablet</h3>
            <div class="lg:w-[35rem] mx-auto">
                <form action="" method="post">
                    ...
                    <div class="f-inter flex flex-col mb-6">
                        ...
                        <input type="text" name="name" value="{{ $tablet->name }}"
                    ...
                    <div class="f-inter flex flex-col mb-6">
                        ...
                        <input type="email" name="email" value="{{ $tablet->email }}"
                            class="bg-[#EEF6F1] border border-[#F3FFF2] py-4 px-3 text-[16px] font-[400] text-[#323232] rounded-[5px] placeholder-[#323232]"
                    ...
                    <div class="f-inter flex flex-col mb-6">
                        <label class="f-inter text-[16px] font-[400] text-[#0D2927] mb-1">Old Password</label>
                        ...
                        @error('oldPassword')
                            <span class="text-red-600" id="message-container">{{ $message }}</span>
                        @enderror
                        <script>
                            var msg = '{{ Session::get('oldPassword') }}';
                            var exist = '{{ Session::has('oldPassword') }}';
                            var messageContainer = document.getElementById('message-container');

                            if (exist === 'true' && msg) {
                                messageContainer.innerHTML = '<span class="text-red-600">' + msg + '</span>';
                            }
                        </script>
                    </div>
                    <div class="f-inter flex flex-col mb-10">
                        <label class="f-inter text-[16px] font-[400] text-[#0D2927] mb-1">New Password</label>


                        <div class="password-container">
                            <input type="password" id="password1" name="newPassword"
                                class="password-input bg-[#EEF6F1] border border-[#F3FFF2] py-4 px-3 text-[16px] font-[400] text-[#323232] rounded-[5px] placeholder-[#323232]"
                                placeholder="Enter a New Password">
                            <i id="togglePassword1" class="fas fa-eye toggle-eye"></i>
                        </div>
                        {{-- <input type="password"  name="newPassword" class=" bg-[#EEF6F1] border border-[#F3FFF2] py-4 px-3 text-[16px] font-[400] text-[#323232] rounded-[5px] placeholder-[#323232]" placeholder="Enter a New Password"> --}}
